...
class DFS_Plugin_Manager
{
    public function __construct() {
        ...
        add_action('admin_menu', [$this, 'df_plugin_add_thickbox']);
        add_action('wp_ajax_df_activate_plugin', [$this, 'ajax_activate_plugin']);
    ...
    public function render_customize_page() {
        ...
        <div class="df_plugin-header">
            ...
            <div class="subtitle">Liste des plugins indispendable pour tout client</div>
        </div>
        <?php $this->recommander_plugins(); ?>
    ...
    public function recommander_plugins() {
            ...
            $this->df_plugin_loop_render($plugins_recommandes);
        }

    public function optionnal_plugins() {
            $plugins_optionnel = [
            ...
            $this->df_plugin_loop_render($plugins_optionnel);
        }

    public function df_plugin_loop_render($plugins){
            ?>
    ...
    public function df_plugin_add_thickbox() {
        add_thickbox();
    }
